...
namespace GTRMod.Survivors.GTRaptor.SkillStates
{
    public class Dash : BaseSkillState
    {
        ...
        public static string dodgeSoundString = "GTRaptorDash";
        ...
        public override void OnEnter()
        {
            ...
            PlayAnimation("FullBody, Override, Dash", "GTR-Kun_Dash", "Dash.playbackRate", duration);
            Util.PlaySound(dodgeSoundString, gameObject);

            if (NetworkServer.active)
            {
                characterBody.AddTimedBuff(GTRaptorBuffs.armorBuff, 3f * duration);
        ...
        public override void FixedUpdate()
        {
            ...
            if (cameraTargetParams) cameraTargetParams.fovOverride = Mathf.Lerp(dodgeFOV, 150f, fixedAge / duration);
