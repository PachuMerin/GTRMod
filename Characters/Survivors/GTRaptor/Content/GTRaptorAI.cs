...
{
    public static class GTRaptorAI
    {
        public static void Init(GameObject bodyPrefab, string masterName)
        {
            ...
            swingDriver.customName = "Use Primary";
            ...
            //Selection Conditions
            shootDriver.customName = "Use Secondary";
