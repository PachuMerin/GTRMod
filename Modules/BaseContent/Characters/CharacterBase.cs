...
namespace GTRMod.Modules.Characters
{
    public abstract class CharacterBase<T> where T : CharacterBase<T>, new()
    {
        ...
        public abstract AssetBundle gtrassets { get; protected set; }
        ...
        {
            instance = this as T;
            gtrassets = Asset.LoadAssetBundle(assetBundleName);
        ...
        {
            characterModelObject = Prefabs.LoadCharacterModel(gtrassets, modelPrefabName);
           
            bodyPrefab = Modules.Prefabs.CreateBodyPrefab(characterModelObject, bodyInfo);
            bodyPrefab.AddComponent<VulcanContoller>();
    ...
    public class BodyInfo
    {
        ...
        #region Camera
        public Vector3 aimOriginPosition = new Vector3(0f, 2.6f, 0f);
        public Vector3 modelBasePosition = new Vector3(0f, 1f, 0f);

        /// <summary> basically the "height" of your camera </summary>
        public Vector3 cameraPivotPosition = new Vector3(0f, 3f, 0f);
        
        /// <summary> how far relative to the pivot is your camera's center </summary>
        public float cameraParamsVerticalOffset = 3.37f;

        /// <summary> large characters like loader are -12. for smaller characters like commando go for -10 maybe -9 </summary>
        public float cameraParamsDepth = -20;
