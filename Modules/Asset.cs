...
namespace GTRMod.Modules
{
    internal static class Asset
    {
        ...
        internal static AssetBundle LoadAssetBundle(string GTRassets)
        {

            if (GTRassets == "myassetbundle")
            {
            ...
            if (loadedBundles.ContainsKey(GTRassets))
            {
                return loadedBundles[GTRassets];
            }

            AssetBundle assetBundle = null;
            try
            {
                assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(GTRaptorPlugin.instance.Info.Location), "AssetBundles", GTRassets));
            }
            catch (System.Exception e)
            {
                Log.Error($"Error loading asset bundle, {GTRassets}. Your asset bundle must be in a folder next to your mod dll called 'AssetBundles'. Follow the guide to build and install your mod correctly!\n{e}");
            }

            loadedBundles[GTRassets] = assetBundle;
